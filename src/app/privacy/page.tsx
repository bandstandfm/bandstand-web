...
export default function Privacy() {
  return (
    <article className="max-w-2xl mx-auto px-6 pt-32 pb-16 prose prose-invert prose-headings:font-serif prose-headings:text-ink prose-p:text-ink/75 prose-a:text-brand prose-strong:text-ink prose-li:text-ink/75">
      ...
      <p><strong>Payment and supporter data.</strong> If you tip Bandstand or subscribe as a Sideman / Bandleader / Patron / Producer supporter, our payment processor (Stripe) collects your payment information directly. Bandstand receives only a customer identifier, the tier or amount, and (for subscriptions) renewal status. We never see or store your full card number or CVV. If you leave a supporter message, we retain the message text alongside your tier.</p>
      ...
      <ul>
        ...
        <li><strong>Stripe</strong> &mdash; to process payments for tips and supporter subscriptions.</li>
      ...
      <ul>
        <li><strong>Account info, favorites, follows, RSVPs:</strong> until you request deletion.</li>
      ...
      <h2>Your rights</h2>
      <p>You can request deletion of your account and all associated data by emailing <a href="mailto:support@bandstand.fm">support@bandstand.fm</a> from the email address you signed in with. We process deletion requests within 14 days. Deletion removes your account, favorites, follows, RSVPs, and supporter messages. Payment records may be retained where required by law but will no longer be linked to your account.</p>
