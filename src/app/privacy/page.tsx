...
export default function Privacy() {
  return (
    <article className="max-w-2xl mx-auto px-6 pt-32 pb-16 prose prose-invert prose-headings:font-serif prose-headings:text-ink prose-p:text-ink/75 prose-a:text-brand prose-strong:text-ink prose-li:text-ink/75">
      ...
      <p><strong>City preference.</strong> he city selector in the app is present in anticipation of future markets but Chicago is the only city with live event listings today; we remember your last-selected city so the app opens where you left off. We do not use GPS or IP-based geolocation.</p>
